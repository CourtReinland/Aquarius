 ...
 * Matches pitch deck slide 39: "Success! You just founded COMMUNITY_NAME
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.detailsCard}>
        ...
        <Text style={styles.detailValue}>Base Sepolia (Testnet)</Text>
      </View>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('CommunityDashboard', { address })
          }
        >
